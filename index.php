...
<body>
    <nav class="justify-content-center text-center navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="welcome-section text-center">
        <h1 class="display-4">Welcome to Primus Dental</h1>
        <p> We are a team of dental professionals dedicated to providing our patients 
            with exceptional dental care in a comfortable and welcoming environment.</p>
            <a href="register.php"><button id="appointment" type="button" class="btn btn-info">Register Now!</button></a> 
      </div>  
      <!-- welcome ends -->
      ...
      <div class="content-section bg-dark text-light text-center p-5">
        <div class="intro">
          <h1 class="display-4">Primus Dental Gallery</h1>
        </div>
