...
<body id="flyIn" class="container text-dark">
    <div class="text-center">
    <h1 class="display-4 p-5">Welcome to the Doctors Panel</h1>
    <p> As Doctor, you can remove irrelevant or false entries.</p>
                ...
                while ($row = mysqli_fetch_assoc($result)){
                    ...
                    '
                        <tr>
                            ...
                            <td>'.$time.'</td>
                            <td>'.$doc.'</td>
                            <td><a class="btn btn-success" href="updatedoc.php?updateid='.$id.'">Update</a></td>
                            <td><a class="btn btn-danger" href="deletedoc.php?deleteid='.$id.'">Delete</a></td>
                        </tr>
                    ';
                }
            }
